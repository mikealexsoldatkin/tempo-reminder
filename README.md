...
| `test/` | тесты окна рабочих дней, отпусков, разбора iCal и отбора проектных ролей (`npm test`) |
...
(кто залогировал, кому ушло напоминание, кто был в отпуске, где ошибка).
