...
/**
 * Страница, которую видит администратор после Slack. Отдаём её целиком из
 * функции: веб-триггер — единственное место приложения, где на экран смотрит
 * не UI Kit, а браузер, и ссылаться отсюда не на что (внешние файлы такой
 * странице недоступны).
 */
function page(statusCode, title, text) {
